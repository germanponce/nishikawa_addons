...

{
    ...
    'description': """
           ...
           Este modulo permite alterar el flujo del Pedido de Compra para las Autorizaciones (Modulo puchase_double_validation)
            ...
            Las Configuracion del Monto permitido esta en el flujo purchase_double_validation y el monto para Aprobacion Directiva en Compras/Configuracion/Parametros
    """,
    'website' : "http://poncesoft.blogspot.com",
    'data': [
        'security/purchase_triple_validation_security.xml',
        'purchase_validation_view.xml'
    ],
    # 'test': [
